...
class ItemEatVC: UIViewController {
    ...
    func getImageReferences(completion: @escaping ([String]) -> ()) {
        ...
        db.collection("eatPlaces").document((placesData?.placeDocumentID)!).collection("images").getDocuments
...
extension ItemEatVC: CLLocationManagerDelegate {
...
extension ItemEatVC: MKMapViewDelegate {
...
extension ItemEatVC: GMSAutocompleteViewControllerDelegate {
...
extension ItemEatVC: UINavigationControllerDelegate, UIImagePickerControllerDelegate {
